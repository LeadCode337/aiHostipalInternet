<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="articleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文章上传时间" align="center" prop="uploadTime" width="180">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="热推顺序" prop="hotOrder">
          <el-input v-model="form.hotOrder" placeholder="请输入热推顺序" />
        </el-form-item>
        ...
        <el-form-item label="文章上传时间" prop="uploadTime">
          <el-date-picker clearable
            ...
            placeholder="请选择文章上传时间">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="文章下架时间" prop="removedTime">
          <el-date-picker clearable
            v-model="form.removedTime"
            type="date"
            value-format="yyyy-MM-dd"
            placeholder="请选择文章下架时间">
          </el-date-picker>
        </el-form-item>
      </el-form>
