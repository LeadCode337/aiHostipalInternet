  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="职称名称" prop="name">
        <el-input
          ...
          placeholder="请输入职称名称，如“主任医师”“主治医师”等"
          clearable
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="职称名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入职称名称，如“主任医师”“主治医师”等" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: "职称名称，如“主任医师”“主治医师”等不能为空", trigger: "blur" }
        ],
        registrationFee: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除职称管理编号为"' + ids + '"的数据项？').then(function() {
        return delTitle(ids)
      }).then(() => {
        this.getList()
